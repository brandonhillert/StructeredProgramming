...
def nieuwe_lijst_feedback(feedback, lijst_combinaties, lijst_feedback ):
    ...
    print(nieuwe_lijst_feedback)
    print(lijst_mogelijke_combinaties)
...
def hoofd_programma():
    ...
    for i in range(10):
        ...
        lijst_feedback = lijst_analyseren_comp(gok_computer, lijst)

        print(lijst_feedback)
        ...
        lijst = nieuwe_lijst_feedback(feedback,lijst, lijst_feedback )
...
gok_computer = random_combinatie_computer(lijst)
lijst_analyseren_comp(gok_computer , lijst )
